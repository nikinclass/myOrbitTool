...
exports.up = function (knex) {
  ...
  return knex.schema.createTable("space_track", (table) => {
    ...
    table.string("EPOCH");
    table.string("MEAN_MOTION");
    table.string("ECCENTRICITY");
    table.string("INCLINATION");
    table.string("RA_OF_ASC_NODE");
    table.string("ARG_OF_PERICENTER");
    table.string("MEAN_ANOMALY");
    table.string("EPHEMERIS_TYPE");
    table.string("CLASSIFICATION_TYPE");
    table.string("NORAD_CAT_ID");
    table.string("ELEMENT_SET_NO");
    table.string("REV_AT_EPOCH");
    table.string("BSTAR");
    table.string("MEAN_MOTION_DOT");
    table.string("MEAN_MOTION_DDOT");
